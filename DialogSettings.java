...
public class DialogSettings extends JDialog implements ChangeListener, FocusListener, ItemListener {
	/*
	 * ActionListener : f�r Button/ ChangeListener : f�r Slider / ItemListener :
	 * f�r Checkbox/ TextEvent, FocusListener : f�r TextField  
	 */
...
//		neuEinstellungen = ((HashMap<String, String>) fenster.getSettings().getEinstellungen().clone());
	...
	private void initCheckBoxes() {
		...
		jcheck[0].setText("Zuf�llige Wartezeit der Gegner");
		...
		jcheck[3].setText("nicht unbegrenzte Anzahl Sch�sse");
...
//		jcbLevel.setSelectedIndex(9);
	...
	private void initLabels() {
		...
		labels[1].setText("Verz�gerung eines Schusses");
	...
	public void itemStateChanged(ItemEvent e) {
		...
		fenster.setCustomLevel(true);
		switch (icBox) {
		case 0: // "Zuf�llige Wartezeit der Gegner"
		...
		case 2: // "Gegner meiden Kollision mit anderen Gegnern"
			...
			break;
		case 3: // "nicht unbegrenzte Anzahl Sch�sse"
