...
public class DialogWonOver {
	...
	public void auswahlNeuSpiel (){	
		...
		spielerAusgewaehlt = JOptionPane.showOptionDialog(fenster, spielStatus[1], spielStatus[0], JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, image, spielerAuswahl,spielerAuswahl[0] ); 
